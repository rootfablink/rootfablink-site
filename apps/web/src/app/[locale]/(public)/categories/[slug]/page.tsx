...
import { normalizePublicSeoText, siteUrl } from "@/lib/seo";
...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; slug: string }> }): Promise<Metadata> {
  ...
  return {
    title: normalizePublicSeoText(category.seoTitle[language]),
    description: normalizePublicSeoText(category.seoDescription[language]),
    alternates: {
