...
type MobileNavKey = "home" | "categories" | "messages" | "basket" | "account";

const navItems: Array<{ key: MobileNavKey; icon: typeof Home; href: string; badge?: string }> = [
      ...
      {navItems.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            <span>{copy.bottomNav[index]}</span>
            {item.badge && (
