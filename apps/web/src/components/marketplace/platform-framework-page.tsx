...
const tr: Record<PlatformModuleKey, ModuleCopy> = {
  "product-detail": moduleCopy("Ürün keşfi", "Ürün detay çalışma alanı", "Fiyat aralığı, MOQ, tedarikçi güven durumu, RFQ aksiyonları ve gelecekteki ticaret güvence akışları için ürün detay temeli.", "Teklif talep et", "Ürünleri incele", ["Ürün görsel galerisi taslağı", "Tedarikçi güven ve doğrulamaya hazır rozeti", "MOQ, teslim süresi ve ambalaj özeti", "Tedarikçiyle iletişim ve RFQ aksiyonları"]),
  "manufacturer-detail": moduleCopy("Üretici keşfi", "Üretici showroom çalışma alanı", "Şirket kabiliyeti, ihracat pazarları, belgeler, ürün kataloğu ve alıcı iletişim akışları için üretici profili temeli.", "Tedarikçiyle iletişim kur", "Üreticileri incele", ["Şirket özeti", "Fabrika ve kabiliyet profili", "Belge incelemeye hazır durum", "Ürün kataloğu önizlemesi"]),
  "rfq-new": moduleCopy("RFQ pazarı", "Teklif talebi oluştur", "Ürün ihtiyacı, varış ülkesi, miktar, sertifika ihtiyacı ve tedarikçi yanıt hazırlığı için alıcı RFQ taslak akışı.", "RFQ taslağını kaydet", "RFQ merkezi", ["Ürün adı ve kategori", "Miktar, birim ve varış ülkesi", "Sertifika ve ek dosya alanları", "Tedarikçi yanıt akışı hazırlığı"]),
  customs: moduleCopy("Gümrük ve uyum", "Gümrük müşaviri ve uyum hizmetleri", "İthalat/ihracat evrakı, GTİP danışmanlığı, uyum desteği ve lead akışları için pazar yeri temeli.", "Gümrük desteği talep et", "Lojistiği incele", ["İthalat gümrük desteği", "İhracat gümrük desteği", "GTİP danışmanlığı", "Evrak hazırlama akışı"]),
  "account-profile": moduleCopy("Hesap merkezi", "Profil yönetimi", "Kimlik, şirket, iletişim ve rol bazlı erişim hazırlığı için alıcı veya tedarikçi hesap çalışma alanı.", "Profili düzenle", "Hesap ana sayfası", ["İletişim bilgileri", "Şirket sahipliği", "Rol ve yetki konsepti", "Backend auth entegrasyon notları"]),
  "account-messages": moduleCopy("Mesajlaşma", "Mesajlar ve müzakere", "Alıcı-tedarikçi mesajları, RFQ bağlantılı görüşme, ek dosyalar ve gelecekteki çeviri desteği için konuşma çalışma alanı.", "Mesajları aç", "Hesap ana sayfası", ["Konuşma listesi", "Profil başlığı", "Mesaj yazma alanı", "RFQ bağlantılı teklif kartı"]),
  "account-favorites": moduleCopy("Alıcı çalışma alanı", "Favori tedarikçiler ve ürünler", "Ürünler, üreticiler ve gelecekteki karşılaştırma listeleri için kayıtlı keşif çalışma alanı.", "Ürünleri incele", "Alıcı merkezi", ["Kayıtlı ürünler", "Kayıtlı tedarikçiler", "Karşılaştırma taslağı", "Arama uyarısı hazırlığı"]),
  "account-rfqs": moduleCopy("Alıcı RFQ'ları", "RFQ yönetim merkezi", "Taslaklar, yayınlanan talepler, tedarikçi yanıtları ve teklif karşılaştırma hazırlığı için alıcı RFQ merkezi.", "RFQ oluştur", "Alıcı merkezi", ["Taslak RFQ'lar", "Yayınlanan RFQ'lar", "Teklif karşılaştırma taslağı", "Yanıt durumu"]),
  ...
  "supplier-dashboard": moduleCopy("Tedarikçi paneli", "Tedarikçi operasyon paneli", "Profil tamamlanma, ürünler, RFQ'lar, mesajlar, doğrulama, analitik ve sponsorlu görünürlük için tedarikçi çalışma alanı.", "Profili tamamla", "Ürün ekle", ["Profil tamamlanma", "Alınan RFQ'lar", "Mesajlar", "Doğrulama durumu"]),
  "supplier-company": moduleCopy("Tedarikçi profili", "Şirket profili yönetimi", "Yasal kimlik, marka bilgisi, ihracat pazarları, kabiliyetler ve showroom metni için şirket profili editör temeli.", "Şirket taslağını kaydet", "Tedarikçi paneli", ["Yasal şirket verisi", "Marka profili", "İhracat pazarları", "Kabiliyetler"]),
  "supplier-products": moduleCopy("Ürün kataloğu", "Tedarikçi ürün kataloğu", "Ürün taslakları, moderasyon durumu, görseller, teknik föyler ve fiyat aralıkları için tedarikçi katalog çalışma alanı.", "Ürün ekle", "Tedarikçi paneli", ["Ürün taslakları", "Katalog moderasyonu", "Görsel alanları", "Teknik föy alanları"]),
  ...
  "supplier-factory": moduleCopy("Fabrika profili", "Fabrika ve kabiliyet profili", "Kapasite, üretim hatları, ekipman, sertifikalar ve denetime hazır belgeler için tedarikçi fabrika çalışma alanı.", "Fabrika taslağını kaydet", "Doğrulama", ["Üretim kapasitesi", "Ekipman", "Fabrika fotoğrafları", "Denetime hazır durum"]),
  ...
  "supplier-rfqs": moduleCopy("RFQ yanıtı", "Tedarikçi RFQ merkezi", "Eşleşen fırsatlar, teklif taslakları ve alıcı yanıt hazırlığı için tedarikçi RFQ çalışma alanı.", "Teklif ver", "Tedarikçi paneli", ["Uygun RFQ'lar", "Teklif taslağı", "Alıcı gereksinimleri", "Yanıt takibi"]),
  "supplier-messages": moduleCopy("Mesajlaşma", "Tedarikçi mesajları", "Alıcı mesajları, ek dosyalar, teklif kartları ve gelecekteki çeviri desteği için tedarikçi konuşma alanı.", "Gelen kutusunu aç", "Tedarikçi paneli", ["Alıcı konuşmaları", "RFQ bağlantılı mesajlar", "Ek dosyalar", "Denetime hazır kayıtlar"]),
  "supplier-analytics": moduleCopy("Analitik", "Tedarikçi analitik merkezi", "Ürün görüntülemeleri, talep sayısı, RFQ dönüşümü, ülke trafiği ve sponsorlu performans için analitik çalışma alanı.", "Raporları görüntüle", "Tedarikçi paneli", ["Ürün görüntülemeleri", "Talep sayısı", "RFQ dönüşümü", "Ülke trafiği"]),
  "supplier-ads": moduleCopy("Sponsorlu görünürlük", "Tedarikçi reklam ve büyüme", "Sponsorlu ürünler, öne çıkan tedarikçiler, kategori sponsorluğu ve RFQ öncelikli görünürlük için gelecek ücretli büyüme modülü.", "Kampanya planla", "Analitik", ["Sponsorlu ürünler", "Öne çıkan tedarikçi sıralaması", "Arama artışı", "RFQ öncelikli görünürlük"]),
  "supplier-documents": moduleCopy("Belgeler", "Tedarikçi belge merkezi", "Kataloglar, sertifikalar, şirket kayıt belgeleri, denetim raporları ve ihracat dosyaları için belge yönetim çalışma alanı.", "Belge yükle", "Doğrulama", ["Kataloglar", "ISO ve CE sertifikaları", "Denetim raporları", "İhracat belgeleri"]),
  ...
  "admin-suppliers": moduleCopy("Admin", "Tedarikçi inceleme merkezi", "Tedarikçi profilleri, onboarding durumları, doğrulama hazırlığı ve moderasyon notları için admin taslağı.", "Tedarikçileri incele", "Doğrulama kuyruğu", ["Tedarikçi profilleri", "Onboarding durumu", "Güven durumu", "İnceleme notları"]),
  ...
  "admin-rfqs": moduleCopy("Admin", "RFQ moderasyonu", "RFQ kalite inceleme, kısıtlı kategori kontrolü, alıcı niyeti ve tedarikçi eşleşme kontrolleri için admin taslağı.", "RFQ'ları incele", "Admin ana sayfası", ["RFQ kuyruğu", "Alıcı niyeti", "Kategori güvenliği", "Eşleşme kontrolleri"]),
