export const en = {
  ...
  footer: {
    ...
    groups: [
      ...
      {
        title: "Trust",
        links: ["Verified suppliers", "Document review", "Audit logs"]
      },
      {
        title: "Company",
  ...
  shell: {
    ...
    navigation: ["Overview", "Company", "Products", "RFQs", "Analytics", "Verification", "Settings"],
    notifications: "Notifications"
  },
  dashboard: {
    title: "Supplier dashboard",
    cards: [
      ["Active RFQs", "18", "5 need quotation review"],
      ["Products", "142", "9 pending approval"],
      ["Trust score", "82", "Verification documents missing"],
      ["Messages", "37", "12 unread buyer threads"]
    ],
    prioritiesTitle: "Next operational priorities",
    priorities: ["Complete company profile", "Upload verification documents", "Publish first product catalog"]
  },
  admin: {
    title: "Admin command center",
    queues: [
      ["Pending supplier verifications", "26"],
      ["Products awaiting approval", "84"],
      ["Open support tickets", "11"],
      ["Suspicious activity alerts", "4"]
    ],
    workflowTitle: "Moderation workflow",
    workflow: ["Review documents", "Approve products", "Audit RFQs", "Resolve disputes"]
  }
};
